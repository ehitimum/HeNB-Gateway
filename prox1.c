...
void process_initating_msg(InitiatingMessage_t *initMsg, char *output_buffer, int output_size, char *NEW_CELL_ID){
    switch (initMsg->value.present) {
        ...
        case InitiatingMessage__value_PR_UEContextReleaseRequest: {
            ...
            replace_UEContextReq_ue_id(releaseReq, output_buffer, output_size);
            break;
        }
...
void process_sucessfullMsg(SuccessfulOutcome_t *success, char *output_buffer, int output_size, char *NEW_CELL_ID){
    switch (success->value.present)
    {
        case SuccessfulOutcome__value_PR_UEContextReleaseComplete:{
            ...
            replace_UEContextCom_ue_id(releaseCom, output_buffer, output_size);
            break;
        }
        case SuccessfulOutcome__value_PR_E_RABSetupResponse:{
            ...
            replace_E_RABSetupRes_ue_id(eRabRes, output_buffer, output_size);
            break;
        }
        case SuccessfulOutcome__value_PR_InitialContextSetupResponse:{
            ...
            replace_InitialContextResponse_ue_id(contex, output_buffer, output_size);
            break;
        }
        default:
...
void replace_InitialContextResponse_ue_id(InitialContextSetupResponse_t *context, char *output_buffer, int output_size)
{
...
void replace_E_RABSetupReq_ue_id(E_RABSetupRequest_t *eRab, char *output_buffer, int output_size)
{
...
void replace_E_RABSetupRes_ue_id(E_RABSetupResponse_t *eRab, char *output_buffer, int output_size)
{
...
void replace_UEContextReq_ue_id(UEContextReleaseRequest_t *ueCont, char *output_buffer, int output_size)
{
...
void replace_UEContextCom_ue_id(UEContextReleaseComplete_t *ueCont, char *output_buffer, int output_size)
{
